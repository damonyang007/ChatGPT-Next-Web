  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview: (overview: any) => {
        return `${overview.chat} 次对话，${overview.message} 条消息，${overview.prompt} 条提示词，${overview.mask} 个功能角色`;
      },
      ImportFailed: "导入失败",
    },
    Mask: {
      Splash: {
        Title: "功能角色启动页",
        SubTitle: "新建聊天时，展示功能角色启动页",
      },
      Builtin: {
        Title: "隐藏内置功能角色",
        SubTitle: "在所有功能角色列表中隐藏内置功能角色",
      },
    },
    Prompt: {
      Disable: {
