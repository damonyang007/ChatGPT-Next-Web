...
function rebootingChuanhu() {
  ...
  pageInfo.innerHTML +=
    '<h1 style="position: absolute; left: 50%; top: 50%; transform: translateX(-50%); color: lightgray; text-align: center; font-family: sans-serif;">Rebooting...</h1>';
  document.body.innerHTML = "";
  document.body.appendChild(pageInfo);

  var requestPing = function () {
    requestGet(
      "./file=web_assets/manifest.json",
      {},
      function (data) {
        location.reload();
      },
...
function restart_reload() {
  document.body.innerHTML =
    '<h1 style="font-family:ui-monospace,monospace;margin-top:20%;color:lightgray;text-align:center;">Reloading...</h1>';
