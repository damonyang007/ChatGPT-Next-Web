...
function setLoclize() {
  ...
  deleteConfirm_i18n_pref = gradioApp().querySelector(
    "#deleteConfirm_i18n_pref",
  ).innerText;
  deleteConfirm_i18n_suff = gradioApp().querySelector(
    "#deleteConfirm_i18n_suff",
  ).innerText;
  ...
  updateSuccess_i18n = gradioApp().querySelector(
    "#updateSuccess_i18n",
  ).innerText;
  updateFailure_i18n = gradioApp().querySelector(
    "#updateFailure_i18n",
  ).innerText;
  ...
  validFileName_i18n = gradioApp().querySelector(
    "#validFileName_i18n",
  ).innerText;
  clearFileHistoryMsg_i18n = gradioApp().querySelector(
    "#clearFileHistoryMsg_i18n",
  ).innerText;
  dropUploadMsg_i18n = gradioApp().querySelector(
    "#dropUploadMsg_i18n",
  ).innerText;
}
