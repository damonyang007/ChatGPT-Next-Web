...
function setChatListHeader() {
  var grHistoryRefreshBtn = gradioApp().querySelector(
    "button#gr-history-refresh-btn",
  );
  var grHistoryUploadBtn = gradioApp().querySelector(
    "button#gr-history-upload-btn",
  );
...
function setChatList() {
  ...
  chatList
    .querySelectorAll(".added-chat-btns")
    .forEach((chat) => chat.classList.remove("added-chat-btns"));
